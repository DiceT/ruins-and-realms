...
export class DiceEngine {
     ...
     * Returns a Promise that resolves with the results when the roll settles.
     */
    public async roll(request: string | import('./types').DiceRollRequest[], options?: { meta?: any }): Promise<RollResult> {
    ...
    public getWorldPosition(screenX: number, screenY: number): { x: number, y: number, z: number } | null {
