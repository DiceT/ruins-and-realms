...
export class PhysicsWorld {
  ...
  public updateBounds(width: number, depth: number) {
    ...
    this.addWall(
      new CANNON.Vec3(0, 0, -offsetZ),
      new CANNON.Vec3(0, 0, 0),
      new CANNON.Vec3(topBotWidth, height, thickness)
    ) // Top
    this.addWall(
      new CANNON.Vec3(0, 0, offsetZ),
      new CANNON.Vec3(0, 0, 0),
    ...
    this.addWall(
      new CANNON.Vec3(-offsetX, 0, 0),
      new CANNON.Vec3(0, Math.PI / 2, 0),
      new CANNON.Vec3(sideLen, height, thickness)
    ) // Left
    this.addWall(
      new CANNON.Vec3(offsetX, 0, 0),
      new CANNON.Vec3(0, Math.PI / 2, 0),
