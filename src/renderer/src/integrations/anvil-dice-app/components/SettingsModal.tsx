...
const ColorInput: React.FC<{ label: string; value: string; onChange: (val: string) => void }> = ({
  label,
  value,
  onChange
}) => (
        ...
        <div style={{ display: 'flex', borderBottom: '1px solid #333' }}>
          <button
            ...
            style={{
              flex: 1,
              padding: '15px',
              background: activeTab === 'appearance' ? '#333' : 'transparent',
              border: 'none',
              color: activeTab === 'appearance' ? 'white' : '#888',
              cursor: 'pointer',
              fontWeight: 'bold'
            }}
          >
          ...
          <button
            ...
            style={{
              flex: 1,
              padding: '15px',
              background: activeTab === 'behavior' ? '#333' : 'transparent',
              border: 'none',
              color: activeTab === 'behavior' ? 'white' : '#888',
              cursor: 'pointer',
              fontWeight: 'bold'
            }}
          >
        ...
        <div style={{ flex: 1, padding: '30px', overflowY: 'auto', display: 'flex', gap: '30px' }}>
            ...
            <>
              ...
              <div style={{ flex: 1, display: 'flex', flexDirection: 'column', gap: '20px' }}>
                  ...
                  <div style={{ padding: '15px', background: '#333', borderRadius: '8px' }}>
                    ...
                    <div style={{ display: 'flex', gap: '15px' }}>
                      <ColorInput
                        ...
                        onChange={(c) => updateTheme({ diceColor: c })}
                      />
                      <ColorInput
                        label="Number"
                        value={settings.theme.labelColor}
                        onChange={(c) => updateTheme({ labelColor: c })}
                      />
                      <ColorInput
                        label="Outline"
                        value={settings.theme.outlineColor}
                        onChange={(c) => updateTheme({ outlineColor: c })}
                      />
                    </div>
                  </div>
                ...
                <div style={{ display: 'flex', gap: '10px' }}>
                  <div style={{ flex: 1 }}>
                    <label style={{ display: 'block', marginBottom: '8px', color: '#aaa' }}>
                      Scale: {settings.theme.scale.toFixed(1)}x
                    </label>
                    <input
                      type="range"
                      min="0.6"
                  ...
                  <div style={{ flex: 1 }}>
                    <label style={{ display: 'block', marginBottom: '8px', color: '#aaa' }}>
                      Contrast: {(settings.theme.textureContrast || 1.0).toFixed(1)}
                    </label>
                    <input
                      type="range"
                      min="0.5"
          ...
          {activeTab === 'behavior' && (
            <div style={{ width: '100%', display: 'flex', flexDirection: 'column', gap: '30px' }}>
              {/* Surface Materials */}
              <div>
                <label style={{ display: 'block', marginBottom: '15px', color: '#aaa' }}>
              ...
              <div>
                <label style={{ display: 'block', marginBottom: '8px', color: '#aaa' }}>
                  Throw Force: {settings.physics.throwForce}
                </label>
                <input
                  type="range"
                  min="20"
                ...
                <div style={{ fontSize: '12px', color: '#666', marginTop: '5px' }}>
                  Higher force = faster, harder rolls.
                </div>
              </div>

              <div>
                <label style={{ display: 'block', marginBottom: '8px', color: '#aaa' }}>
                  Gravity: {settings.physics.gravity.toFixed(1)}
                </label>
                <input
                  type="range"
                  min="5"
              ...
              <div>
                ...
                />
                <div style={{ fontSize: '12px', color: '#666', marginTop: '5px' }}>
                  Adjust sound effects volume (0 to mute).
                </div>
              </div>
