...
export class TerrainAssetLoader {
  ...
  public static async loadAll(): Promise<void> {
    ...
    const modules = import.meta.glob<{ default: string }>('../../assets/images/overland-tiles/*/*.png', { eager: true })
    ...
    this.loaded = true
    console.log('[TerrainAssetLoader] Loaded terrain assets:', Object.keys(this.textures).map(k => `${k}: ${this.textures[k].length}`))
  }
